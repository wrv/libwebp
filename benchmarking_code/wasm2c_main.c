...
int main(int argc, const char** argv) {
  ...
  w2c_simple__dwebp__wasm inst = { 0 };
  ...
  wasm2c_simple__dwebp__wasm_instantiate(&inst, &wasi_env);

  /* Call `inst`, using the mangled name. */
  w2c_simple__dwebp__wasm_0x5Fstart(&inst);

  /* Free the inst module. */
  wasm2c_simple__dwebp__wasm_free(&inst);
