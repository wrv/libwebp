...
#if (defined(__SSE2__) || defined(WEBP_MSC_SSE2) || defined(WEBP_USE_SIMDE)) && \
...
#if (defined(__SSE4_1__) || defined(WEBP_MSC_SSE41) || defined(WEBP_USE_SIMDE)) && \
...
#if ((defined(__ARM_NEON__) || defined(__aarch64__) || defined(WEBP_USE_SIMDE)) &&       \
